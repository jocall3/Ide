...
// FIX: Updated all Icon components to accept all standard SVG props (like style) to fix type errors.
...
export const NewFileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  React.createElement(Icon, {
    ...props,
    viewBox: "0 0 20 20",
    children: React.createElement('path', { d: "M13.59 2L12 3.59V2H6v16h12V8h-4.41L15 6.41V4h-1.59zM11 8V3.5L15.5 8H11zM4 20V4h1v16H4z" })
  })
);
...
export const NewFolderIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  React.createElement(Icon, {
    ...props,
    viewBox: "0 0 20 20",
    children: React.createElement('path', { d: "M2 4h6l2 2h8v12H2V4zm10 4H4v10h14V8h-8l-2-2z" })
  })
);
...
export const FileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  React.createElement(Icon, {
    ...props,
    viewBox: "0 0 16 16",
    children: React.createElement('path', { d: "M3.5 2A1.5 1.5 0 0 0 2 3.5v9A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5v-7L9.5 2h-6z" })
  })
);
...
export const FolderIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  React.createElement(Icon, {
    ...props,
    viewBox: "0 0 16 16",
    children: React.createElement('path', { d: "M1 3.5A1.5 1.5 0 0 1 2.5 2h3.146a1.5 1.5 0 0 1 1.06.44L8.5 4H13.5A1.5 1.5 0 0 1 15 5.5v5A1.5 1.5 0 0 1 13.5 12h-11A1.5 1.5 0 0 1 1 10.5v-7z" })
  })
);